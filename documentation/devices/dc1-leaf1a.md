...
| Loopback10 | A_DC1_VTEP_DIAGNOSTICS | A_DC1 | 10.254.10.3/32 |
| Loopback11 | B_DC1_VTEP_DIAGNOSTICS | B_DC1 | 10.254.11.3/32 |
| Loopback12 | C_DC1_VTEP_DIAGNOSTICS | C_DC1 | 10.254.12.3/32 |
...
| Vlan3009 |  A_DC1  |  10.254.2.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC1  |  10.254.2.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  C_DC1  |  10.254.2.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.254.0.0 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.0.2 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | A_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | B_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | C_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 1.1.1.3:10100 | 10100:10100 | - | - | learned |
| 110 | 1.1.1.3:10110 | 10110:10110 | - | - | learned |
| 120 | 1.1.1.3:10120 | 10120:10120 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A_DC1 | 1.1.1.3:10 | connected |
| B_DC1 | 1.1.1.3:11 | connected |
| C_DC1 | 1.1.1.3:12 | connected |
...
```eos
!
ip address virtual source-nat vrf A_DC1 address 10.254.10.3
ip address virtual source-nat vrf B_DC1 address 10.254.11.3
ip address virtual source-nat vrf C_DC1 address 10.254.12.3
```
