...
| Loopback10 | A_DC2_VTEP_DIAGNOSTICS | A_DC2 | 10.255.10.5/32 |
| Loopback11 | B_DC2_VTEP_DIAGNOSTICS | B_DC2 | 10.255.11.5/32 |
| Loopback12 | C_DC2_VTEP_DIAGNOSTICS | C_DC2 | 10.255.12.5/32 |
...
| Vlan3009 |  A_DC2  |  10.255.2.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC2  |  10.255.2.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3021 |  C_DC2  |  10.255.2.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| --- | ------------------- | ------------ |
| A_DC2 | 3.3.3.5:10 | connected |
| B_DC2 | 3.3.3.5:11 | connected |
| C_DC2 | 3.3.3.5:22 | connected |
...
```eos
!
ip address virtual source-nat vrf A_DC2 address 10.255.10.5
ip address virtual source-nat vrf B_DC2 address 10.255.11.5
ip address virtual source-nat vrf C_DC2 address 10.255.12.5
```
