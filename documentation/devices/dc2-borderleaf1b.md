...
| --------- | --------------- | ------------ | --------- |
| DC2_BORDER_LEAFS | Vlan4094 | 10.255.1.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_dc2-borderleaf1a_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_dc2-borderleaf1a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet6 | routed | - | 10.255.0.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SPINE2_Ethernet6 | routed | - | 10.255.0.23/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_dc1-borderleaf1b_Ethernet8 | routed | - | 172.100.100.3/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_dc2-borderleaf1a_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 3.3.3.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 4.4.4.7/32 |
| Loopback10 | A_DC2_VTEP_DIAGNOSTICS | A_DC2 | 10.255.10.8/32 |
| Loopback11 | B_DC2_VTEP_DIAGNOSTICS | B_DC2 | 10.255.11.8/32 |
| Loopback12 | C_DC2_VTEP_DIAGNOSTICS | C_DC2 | 10.255.12.8/32 |
...
| Vlan3009 |  A_DC2  |  10.255.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC2  |  10.255.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3021 |  C_DC2  |  10.255.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.1.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 1.1.1.8 | 65199 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
...
| 10.255.0.20 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.0.22 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.100.100.2 | 65199 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | A_DC2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | B_DC2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | C_DC2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 200 | 3.3.3.8:20200 | 20200:20200 | - | - | learned |
| 210 | 3.3.3.8:20210 | 20210:20210 | - | - | learned |
| 220 | 3.3.3.8:20220 | 20220:20220 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A_DC2 | 3.3.3.8:10 | connected |
| B_DC2 | 3.3.3.8:11 | connected |
| C_DC2 | 3.3.3.8:22 | connected |
...
```eos
!
ip address virtual source-nat vrf A_DC2 address 10.255.10.8
ip address virtual source-nat vrf B_DC2 address 10.255.11.8
ip address virtual source-nat vrf C_DC2 address 10.255.12.8
```
