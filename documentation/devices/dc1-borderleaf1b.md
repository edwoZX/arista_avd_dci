...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.1.8/24 | 192.168.1.254 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAFS | Vlan4094 | 10.254.1.8 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_dc1-borderleaf1a_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_dc1-borderleaf1a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet6 | routed | - | 10.254.0.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet6 | routed | - | 10.254.0.23/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_dc2-borderleaf1b_Ethernet8 | routed | - | 172.100.100.2/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_dc1-borderleaf1a_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 1.1.1.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 2.2.2.7/32 |
| Loopback10 | A_DC1_VTEP_DIAGNOSTICS | A_DC1 | 10.254.10.8/32 |
| Loopback11 | B_DC1_VTEP_DIAGNOSTICS | B_DC1 | 10.254.11.8/32 |
| Loopback12 | C_DC1_VTEP_DIAGNOSTICS | C_DC1 | 10.254.12.8/32 |
...
| Vlan3009 |  A_DC1  |  10.254.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC1  |  10.254.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  C_DC1  |  10.254.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.254.2.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.254.1.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| 3.3.3.8 | 65299 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
| 10.254.0.20 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.0.22 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.100.100.3 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | A_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | B_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | C_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 1.1.1.8:10100 | 10100:10100 | - | - | learned |
| 110 | 1.1.1.8:10110 | 10110:10110 | - | - | learned |
| 120 | 1.1.1.8:10120 | 10120:10120 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A_DC1 | 1.1.1.8:10 | connected |
| B_DC1 | 1.1.1.8:11 | connected |
| C_DC1 | 1.1.1.8:12 | connected |
...
```eos
!
ip address virtual source-nat vrf A_DC1 address 10.254.10.8
ip address virtual source-nat vrf B_DC1 address 10.254.11.8
ip address virtual source-nat vrf C_DC1 address 10.254.12.8
```
