...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 10.254.1.0 | Port-Channel3 |
...
| Ethernet8 | DC1_HOST1_VLAN100_G0/1 | *trunk | *100 | *4092 | *- | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 10.254.0.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 10.254.0.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description DC1_HOST1_VLAN100_G0/1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 1.1.1.4/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 2.2.2.3/32 |
| Loopback10 | A_DC1_VTEP_DIAGNOSTICS | A_DC1 | 10.254.10.4/32 |
| Loopback11 | B_DC1_VTEP_DIAGNOSTICS | B_DC1 | 10.254.11.4/32 |
| Loopback12 | C_DC1_VTEP_DIAGNOSTICS | C_DC1 | 10.254.12.4/32 |
...
| Vlan3009 |  A_DC1  |  10.254.2.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC1  |  10.254.2.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  C_DC1  |  10.254.2.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.254.2.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.254.1.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.254.0.4 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.0.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | A_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | B_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | C_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 1.1.1.4:10100 | 10100:10100 | - | - | learned |
| 110 | 1.1.1.4:10110 | 10110:10110 | - | - | learned |
| 120 | 1.1.1.4:10120 | 10120:10120 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A_DC1 | 1.1.1.4:10 | connected |
| B_DC1 | 1.1.1.4:11 | connected |
| C_DC1 | 1.1.1.4:12 | connected |
...
router bgp 65101
   ...
   neighbor 10.254.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.254.0.4 remote-as 65001
   neighbor 10.254.0.4 description dc1-spine1_Ethernet2
   neighbor 10.254.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.254.0.6 remote-as 65001
   neighbor 10.254.0.6 description dc1-spine2_Ethernet2
   neighbor 10.254.2.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.254.2.0 description dc1-leaf1a
...
```eos
!
ip address virtual source-nat vrf A_DC1 address 10.254.10.4
ip address virtual source-nat vrf B_DC1 address 10.254.11.4
ip address virtual source-nat vrf C_DC1 address 10.254.12.4
```
