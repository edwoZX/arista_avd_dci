...
| Loopback10 | A_DC1_VTEP_DIAGNOSTICS | A_DC1 | 10.254.10.7/32 |
| Loopback11 | B_DC1_VTEP_DIAGNOSTICS | B_DC1 | 10.254.11.7/32 |
| Loopback12 | C_DC1_VTEP_DIAGNOSTICS | C_DC1 | 10.254.12.7/32 |
...
| Vlan3009 |  A_DC1  |  10.254.2.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  B_DC1  |  10.254.2.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  C_DC1  |  10.254.2.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 3.3.3.7 | 65299 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
| 10.254.0.16 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.0.18 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 172.100.100.1 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.254.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | A_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | B_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.254.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | C_DC1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| A_DC1 | 1.1.1.7:10 | connected |
| B_DC1 | 1.1.1.7:11 | connected |
| C_DC1 | 1.1.1.7:12 | connected |
...
```eos
!
ip address virtual source-nat vrf A_DC1 address 10.254.10.7
ip address virtual source-nat vrf B_DC1 address 10.254.11.7
ip address virtual source-nat vrf C_DC1 address 10.254.12.7
```
